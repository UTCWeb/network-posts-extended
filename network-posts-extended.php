...
Description: NO LONGER SUPPORTED: Network Posts Extended plugin enables you to share posts over WP Multi Site network.  You can display on any blog in your network the posts selected by taxonomy from any blogs including main.
Version: 8.0
Author: John Cardell, Andrey Islentiev, Bridget Hornsby (updated deprecations)
